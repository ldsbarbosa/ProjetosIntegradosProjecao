...
class PlacaMae extends Model
{
    ...
    public function rules(){
        return [
            'nome' => 'required|unique:placas_mae,nome,'.$this->id.'|min:3',
            'preco' => 'required|numeric|min:3',
            'marca' => 'required|min:3',
            'qtd_slots_memoria' => 'required|numeric'
        ];
    }
    ...
    public function computadores(){
        return $this->hasMany('App\Models\Computador','placa_mae_id');
    }
}
